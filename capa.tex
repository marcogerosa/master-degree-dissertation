...
\begin{center}
    \vspace*{0.2cm}
    \textbf{\Large{Code Smells no Domínio de Aplicações Android a ser apresentado à CPG para a dissertação}}\\
...
\thispagestyle{empty}
	\begin{center}
    	\vspace*{0.2 cm}
        \textbf{\Large{Code Smells no Domínio de Aplicações Android a ser apresentado à CPG para dissertação}}\\
	    \vspace*{2 cm}
	\end{center}
