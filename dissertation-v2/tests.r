...
comportamento_suspeito_clean <- c(1,2,0,2,3,0,0,5,0,0,0,1,4,0,0,2,0,2,3,0,2)
...
componente_ui_inteligente_clean <- c(3,1,0,2,2,0,4,0,2,4,3,2,0,2,0,5,4,0,0,0,4,2,5,0,0,3,1,0,4,0,4,0,0,2,3,3,2,lcui_clean)
...
longo_recurso_estilo_clean <- c(0,3,2,0,2,5,3,0,1,2,5,2,3,0,2,0,0,1,0,0)
...
layout_profundamente_aninhado_clean <- c(0,3,0,1,0,0,0,0,0,0,0,2,3,2,0,0,0,0,0,0,3,4,2,0,0,0,0,3,0,1,2,1,0,2,0,1,2,4,0,lpa_clean)

atributos_estilo_repetidos_smelly <- c(5,0,0,3,2,3,0,2,1,3,4,3,4,0,0,0,2,4,2,3,4,3,1)
atributos_estilo_repetidos_clean <- c(0,3,0,1,0,0,0,0,0,2,3,2,0,0,0,0,0,0,3,4,2,0,0,0,3,0,1,2,1,0,2,1,2,4,0)
