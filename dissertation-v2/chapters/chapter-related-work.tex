...
\begin{itemize}
  \item A Seção X.X apresenta diversas pesquisas que encontraram características que diferenciam projetos Android de projetos de software tradicionais, como projetos web e cliente/servidor.  

  \item A Seção X.X apresenta pesquisas que têm demonstrado que diferentes tecnologias podem apresentar maus cheiros específicos.

  \item A Seção X.X apresenta pesquisas que já vem investigando a presença de maus cheiros tradicionais em projetos Android, a existência de maus cheiro específicos ao Android e ainda comparando a presença dos maus cheiros tradicionais vs. a presença de maus cheiros específicos em projetos Android. 
\end{itemize}
