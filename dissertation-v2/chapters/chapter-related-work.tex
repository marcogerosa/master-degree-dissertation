...
\begin{itemize}
  ...
  \item A Seção \ref{maus-cheiros-android} apresenta pesquisas que já vem investigando 1) a presença de maus cheiros tradicionais em aplicativos Android, 2) a existência de maus cheiro específicos ao Android e também 3) comparando a presença dos maus cheiros tradicionais vs. a presença de maus cheiros específicos em aplicativos Android. Estas pesquisas reforçam a relevância de investigarmos maus cheiros específicos ao Android pois concluem que maus cheiros específicos aparecem muito mais do que os maus cheiros tradicionais.
\end{itemize}
