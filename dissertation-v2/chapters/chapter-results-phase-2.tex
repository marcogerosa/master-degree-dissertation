...
% % A PARADA ESTÁ AQUI
% Ao final do período em que o experimento esteve aberto, foi possível coletar dados para validar estatisticamente a percepção sobre 7 dos 20 maus cheiros propostos. Tabela \ref{tab:selected-smells} lista os maus cheiros avaliados bem como dados de mediana, moda e desvio padrão.

% % Para definirmos quais maus cheiros seriam avaliados no experimento, usamos o seguinte critério: maus cheiros com MO de importância e frequência maior ou igual a 3 e DP de importância e frequência inferior a 1,20. A Tabela \ref{tab:selected-smells} lista os maus cheiros avaliados no experimento.
...
Os três maus cheiros que obtiveram mais respostas de ``não é importante'' foram: \textsc{\small Reúso Inadequado de String}, \textsc{\small Não Uso de Fragment}, \textsc{\small Uso Excessivo de Fragment}. São os mesmos que tiveram menor concordância com relação à sua importância, todos com DP acima de 1,28.
