...
\renewcommand*{\arraystretch}{1}
\footnotesize 
\caption{Listagem dos maus cheiros do \textit{front-end} Android de acordo com seu nível de importância, alta ou moderada.}
...
\renewcommand*{\arraystretch}{1}
\footnotesize 
\caption{Listagem dos maus cheiros do \textit{front-end} Android de acordo com seu nível de frequência, alta, moderada ou baixa.}
\begin{tabular}{@{}p{5.2cm}p{5.2cm}p{5.2cm}@{}}
\toprule
