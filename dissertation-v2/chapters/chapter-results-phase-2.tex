...
Nossos resultados mostraram que os 20 maus cheiros propostos são considerados, em diferentes níveis, como importantes e se apresentam com diferentes frequências no dia a dia do desenvolvimento Android. As distribuições relativas de frequência e importância sobre cada afirmação pode ser conferida nos Apêndices \ref{appendix-phase2-frequence-table} (afirmações de frequência) e \ref{appendix-phase2-importance-table} (afirmações de importância).
...
\textsc{\scriptsize Componente de UI Cérebro} & \textsc{\scriptsize Recurso de String Bagunçado} & \textsc{\scriptsize } \\ 
\textsc{\scriptsize Recurso Mágico} & \textsc{\scriptsize Imagem Faltante} & \textsc{\scriptsize } \\ 
...
\textsc{\scriptsize Recurso Mágico} & \textsc{\scriptsize } & \textsc{\scriptsize } \\ 
