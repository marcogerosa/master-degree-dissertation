\section{Etapa 2 - Frequência e importância dos maus cheiros}
\label{etapa-2}
...
% \end{subfigure}% 
% \caption{Experiência com desenvolvimento de software e desenvolvimento Android dos participantes de S$_2$.}
% \label{fig:phase2-participants-experience}
% % \vspace{-.5cm} 
% \end{figure*}
