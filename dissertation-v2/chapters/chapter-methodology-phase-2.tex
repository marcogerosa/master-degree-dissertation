...
A seguir apresentamos detalhes sobre a concepção do questionário, sobre os participantes e sobre o processo de análise dos dados.
...
Conforme apresentado na Figura \ref{fig:phase2-participants-experience}, 94\% dos 201 respondentes indicaram ter 2 anos ou mais de experiência com desenvolvimento de software e 74\% indicaram 2 anos ou mais de experiência com desenvolvimento Android. Este resultado pode nos indicar que conseguimos atingir desenvolvedores com experiência considerável em desenvolvimento de software e Android, entendemos este resultado de forma positiva. 
...
Perguntamos aos desenvolvedores qual seu nível de conhecimento em diversas linguagens orientadas a objetos. Na Figura \ref{fig:phase2-participants-languages} podemos observar que mais de 80\% se consideram com conhecimento de intermediário a avançado em Java e Android. De 20\% a 58\% dos respondentes afirmam ter conhecimento de intermediário a avançado em outras linguagens orientadas a objetos. A linguagem de programação menos conhecida pelos desenvolvedores que responderam ao questionário é o Ruby, seguida por Objective-C, Swift e Python.
...
\end{figure*}
 ...
 A Figura \ref{fig:phase2-participants-regions} apresenta a distribuição geográfica global e no Brasil dos respondentes. Nosso questionário confirmatório foi respondido por profissionais de 3 continentes diferentes, porém a maior representatividade dos dados é originada do Brasil com pouco mais de 78\% dos respondentes. Desse total, os estados com maior representatividade foram, na ordem: São Paulo com 57\%, Rio de Janeiro e Minhas Gerais com quase 6\% e Rio Grande do Sul com quase 5\%. 10\% dos participantes são originados de países Europeus. Nos Estados Unidos tivemos apenas 2\%. 
...
\end{figure*}
 ...
 Podemos concluir que tivemos certa abrangência geográfica, porém o padrão obtido em S1 voltou a se repetir em S2, de que apesar de termos tido esta abrangência, a maior representatividade é provinda do Brasil, logo, continuamos acreditando que o mais apropriado seja dizer que a confirmação de frequência e importância dos maus cheiros derivados representam a opinião de desenvolvedores brasileiros.
