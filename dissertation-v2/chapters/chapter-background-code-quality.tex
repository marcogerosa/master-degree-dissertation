...
Em uma postagem em seu site oficial em 2006 \cite{CodeSmell:06}, Fowler afrouxou um pouco mais a definição do termo dizendo que \textit{``um mau cheiro de código é uma indicação superficial que geralmente corresponde a um problema mais profundo no sistema''}.
...
\subsection{Maus Cheiros em Orientação a Objetos}
