...
A seguir introduzimos brevemente cada um dos conceitos e subconceitos do \ac{SQuaRE}.
...
\subsection{Padrões de Projeto}
  ...
  \begin{figure}[!htb]
    ...
    \caption{Formato de padrões com relação a maturidade e clareza definido por Joshua Kerievzky \cite{PatternsFormats}.}
...
\subsection{Anti-Padrões}
  ...
  Um anti-padrão é uma resposta comum a um problema recorrente que geralmente é ineficaz e corre o risco de ser altamente contraproducente. O termo foi cunhado por Andrew Koenig em um artigo publicado em 1995 [???], inspirado pelo livro GoF \cite{GoF:95}. 
