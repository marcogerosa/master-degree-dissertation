...
A seguir, na Seção \ref{phase1-general-results} apresentamos alguns resultados gerais. Na Seção \ref{phase1-code-smells-derivation} abordamos o processo de definição dos maus cheiros. Na Seção \ref{phase1-code-smells-reliability} abordamos sobre a confiabilidade do mau cheiro e por último, na Seção \ref{phase1-code-smells-catalog} apresentamos o catálogo derivado com 21 maus cheiros do \textit{front-end} Android.
