...
Nesta seção apresentamos alguns resultados gerais sobre o processo de derivação dos maus cheiros (Seção \ref{phase1-general-results}) e o catálogo com os 20 maus cheiros propostos relacionados à camada de apresentação Android (Seção \ref{phase1-code-smells-derivation}).
