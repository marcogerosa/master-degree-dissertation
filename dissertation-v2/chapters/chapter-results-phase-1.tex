...
\toprule
\textsc{Componente de UI Inteligente}$^{(60)}$   & 29  & 16  & 14  & 1   & -    & -   & -   & -  &  \\
...
Vale observar que um mesmo mau cheiro pode afetar mais de um elemento da camada de apresentação Android. Para alguns maus cheiros, os elementos que ele apresenta ocorrência também são os elementos que ele pode afetar, como por exemplo, \textsc{\small Componente de UI Inteligente} se apresenta nos 4 componentes (\textit{Activities}, \textit{Fragments}, \textit{Adapters} e \textit{Listeners}) e pode afetar os mesmos 4. 
...
\toprule
\textsc{Componente de UI Inteligente}$^{(60)}$       & Componentes de UI com lógicas de negócio.  \\
