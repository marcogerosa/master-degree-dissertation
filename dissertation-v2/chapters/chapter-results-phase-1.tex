...
\section{QP$_1$: Existem maus cheiros que são específicos a camada de apresentação Android?} 
\label{phase1-results}

\begin{square}
  \small
  Existem maus cheiros específicos à camada de apresentação Android (QP$_1$).
\end{square}
