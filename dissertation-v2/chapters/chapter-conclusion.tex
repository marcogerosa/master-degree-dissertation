...
Neste capítulo, nós revisitamos as questões de pesquisa e apresentamos as respondemos (Seção \ref{sec:respostas-questoes-pesquisa}), sugerimos trabalhos futuros (Seção \ref{sec:trabalhos-futuros}) e discutimos alguns resultados (Seção \ref{sec:discussoes}).
