...
\begin{enumerate}
  ...
  \item Apêndice online~\cite{apendice} com informações detalhadas dos roteiros dos questionários e outras da pesquisa para que outros pesquisadores possam replicar nosso estudo.
\end{enumerate}
