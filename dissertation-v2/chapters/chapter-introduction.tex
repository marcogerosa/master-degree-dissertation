...
Evidências na literatura sugerem que maus cheiros são percebidos negativamente por desenvolvedores~\cite{Palomba_Do_2014}. A fim de validar a percepção de desenvolvedores Android sobre os maus cheiros propostos, realizamos um experimento de código pelo qual foi possível validar a percepção de 6 dos 20 maus cheiros. No experimento o desenvolvedor era solicitado a avaliar 6 códigos dentre os quais, haviam códigos mau cheirosos (afetado por algum mau cheiro proposto) e limpos (não afetado por maus cheiros). Recebemos 70 respostas, a partir das quais extraímos dados estatísticos que confirmam que desenvolvedores percebem os códigos afetados pelos maus cheiros como códigos problemáticos.
...
\begin{itemize}
  ...
  \item Uma análise estatística confirmando que códigos afetados por 6, dos 20 maus cheiros, são percebidos como problemáticos por desenvolvedores Android.
...
\begin{itemize}
  ...
  \item Por fim, no Capítulo \ref{conclusao} concluímos respondemos as questões de pesquisa, sugerimos trabalhos futuros e discutindo alguns resultados.
\end{itemize}
