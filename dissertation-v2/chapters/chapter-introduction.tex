...
Dentre as tecnologias que surgiram na última década, o Android surgiu há 9 anos e apresentou um forte crescimento. Ganhou tanta popularidade no desenvolvimento móvel que se tornou a principal plataforma móvel dos últimos anos. Entretanto, o Android é ainda uma plataforma jovem se compararmos por exemplo, com Java, plataforma mais usada nas últimas décadas e que existe há mais de 20 anos. Desta forma, enquanto que existem diversas pesquisas e literaturas que tratam de boas práticas no desenvolvimento Java e orientado a objetos, são poucas as que tratam de boas práticas no desenvolvimento Android. Encontramos esta mesma conclusão de forma recorrente em diversas pesquisas sobre Android [??].
...
Para responder a esta pergunta, foi preciso elaboras três sub-perguntas:

\begin{itemize}
  \item[ ] \textbf{QP1.1. O que desenvolvedores consideram boas e más práticas no desenvolvimento do \textit{front-end} Android?}

  Essa é uma pergunta muito importante visto que maus cheiros são derivados de conhecimento empírico de desenvolvedores experientes. Logo, entender o que são consideradas boas e más práticas por eles nos darão as primeiras ideias fundamentais para buscar pelos maus cheiros do \textit{front-end} Android.
  ...
  Não basta apenas sabermos o que são boas e más práticas do ponto de vista individual do desenvolvedor se este ponto de vista não for observado de forma recorrente por outros desenvolvedores pois, um maus cheiro deve ser percebido como uma situação problemática por mais pessoas.

  \item[ ] \textbf{QP1.3. Quais maus cheiros podemos derivar a partir das boas e más práticas coletadas?}

  Se existirem de fato boas e más práticas percebidas de forma recorrente por desenvolvedores Android, então é possível extrairmos maus cheiros de código. Pois conforme fulano...
\end{itemize}
