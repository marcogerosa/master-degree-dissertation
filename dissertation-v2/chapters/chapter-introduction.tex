...
\begin{center}
\textbf{QP1: Existem maus cheiros que são específicos a camada de apresentação de aplicativos Android?}
\end{center}
...
Como principal questão de pesquisa, objetiva investigar a existência de maus cheiros no desenvolvimento da camada de apresentação Android e caso existam, documentá-los. A percepção de desenvolvedores é sempre importante quando lidamos com manutenção de software \cite{arcoverde2011understanding, Palomba_Do_2014, yamashita2013developers}. Portanto é necessário explorar o conhecimento empírico de desenvolvedores Android \cite{JavascriptSmells, JavaQADetectingSmells:02}.

Esta questão nos fornece as primeiras ideias sobre maus cheiros na camada de apresentação Android. Buscamos respondê-la por meio de um questionário online submetido a desenvolvedores Android perguntando-os sobre o que consideram boas e más práticas no desenvolvimento da camada de apresentação Android. 
