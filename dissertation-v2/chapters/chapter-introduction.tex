...
\emph{``Estamos cientes de que um bom código importa, pois já tivemos que lidar com a falta dele por muito tempo''} \cite{CleanCode:08}. De fato, não há mais dúvida de que bons códigos importam. Mas como saber se um código está com baixa qualidade? Uma das formas que temos de responder a essa pergunta é buscando por \emph{maus cheiros} no código. Maus cheiros de código auxiliam desenvolvedores na identificação de trechos de códigos problemáticos, de forma que eles possam ser melhorados e a qualidade do software incrementada \cite{Refactoring:99}. 
