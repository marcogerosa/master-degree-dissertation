...
\emph{``Estamos cientes de que um bom código importa, pois já tivemos que lidar com a falta dele por muito tempo''} \cite{CleanCode:08}. De fato, não há mais dúvida de que bons códigos importam. Mas como saber se um código está com a qualidade baixa? Uma das formas que temos de responder a essa pergunta é buscando por \emph{maus cheiros} no código. Maus cheiros de código auxiliam desenvolvedores na identificação de trechos de códigos problemáticos, de forma que eles possam ser melhorados e a qualidade do software incrementada \cite{Refactoring:99}. 
...
Nesta dissertação, investigamos a existência de maus cheiros de código relacionados ao \textit{front-end} Android. Outras pesquisas investigaram maus cheiros em termos de eficiência e usabilidade, diferente delas, nós buscamos por maus cheiros relacionados a manutenibilidade, que trata da facilidade do software de ser modificado ou aprimorado. Complementamos as pesquisas anteriores pois focamos no \textit{front-end} Android considerando inclusive os recursos da aplicação. 

Nossos dados foram obtidos por meio de dois questionários online. No primeiro questionamos desenvolvedores Android sobre boas e más práticas utilizadas no dia a dia do desenvolvimento do \textit{front-end} e obtivemos 45 respostas, das quais derivamos 21 maus cheiros. No segundo validamos a percepção de desenvolvedores Android sobre a frequência e importância desses maus cheiros, obtivemos 201 respostas. Por último realizamos um experimento de código presencial em três etapas com 75 desenvolvedores Android.
