...
\emph{``Estamos cientes de que um bom código importa, pois já tivemos que lidar com a falta dele por muito tempo''} \cite{CleanCode:08}. De fato, não há mais dúvida de que bons códigos importam. Mas como saber se um código está bom ou não? Uma das formas que temos de responder a essa pergunta é buscando por \emph{maus cheiros} no código. Maus cheiros de código auxiliam desenvolvedores na identificação de trechos de códigos problemáticos, de forma que eles possam ser melhorados. Existem diversos maus cheiros catalogados, porém muitos deles foram baseados em conceitos e tecnologias existentes na época, como orientação a objetos e Java \cite{Refactoring:99, CleanCode:08, Refactoring:14, Webster:95}. A esses daremos o nome de maus cheiros \emph{tradicionais}.

Nas últimas décadas surgiram  diversas novas tecnologias que começaram a levantar questões como: \emph{``os maus cheiros tradicionais se aplicam a essas novas tecnologias?''} ou \emph{``haveriam maus cheiros específicos a essas novas tecnologias, ainda não catalogados?''}. Questões como essas instigaram a curiosidade de diversos pesquisadores que decidiram investigar maus cheiros em tecnologias específicas como por exemplo o CSS \cite{CSSCodeSmell}, o Javascript \cite{JavascriptSmells}, o arcabouço Spring MVC \cite{MvcSmells:16} e inclusive fórmulas de planilhas do Google \cite{SpreadsheetsSmells:12}.

Dentre as tecnologias que surgiram na última década, uma que se destacou foi o Android. Android é uma plataforma móvel que foi lançada em 2008 pelo Google em parceria com diversas empresas \cite{OHAReleasesAndroidSDK:07}. Em 2011 se tornou a principal plataforma móvel global e desde então vem aumentando sua fatia de mercado, tendo em 2017 alcançado 86\% \cite{GlobalSmartphoneSales:09-17}. 

O Android também chamou a atenção de pesquisadores da área de qualidade de software que investigaram a existência de maus cheiros tradicionais em aplicativos Android \cite{Hecht:15, DomainMatters, MobileSmells:13} e a existência de maus cheiros específicos ao Android relacionados a eficiência e usabilidade \cite{RemovingEnergySmells:12, 30QualitySmells:14}. Dentre as descobertas realizadas pelos pesquisadores, notou-se que maus cheiros específicos são muito mais frequentes em aplicativos Android do que maus cheiros tradicionais \cite{Hecht:15}. Os componentes mais afetados por maus cheiros tradicionais estão relacionados a interface visual, também chamada de \textit{front-end}, como \textsc{Activities} e \textsc{Adapters} \cite{Hecht:15, Mantyla2013, MobileSmells:13} e que em alguns aplicativos, códigos relacionados ao \textit{front-end} são maioria, em termos de LOC (Linhas de Código) \cite{Mantyla2013}. O código do \textit{front-end} do Android é composto também por arquivos \texttt{XML}, chamados de recursos da aplicação, que são usados para construir a UI \cite{AndroidFundamentals}. Nenhuma das pesquisas mencionadas considerou estes arquivos em suas análises. 

Nesta dissertação investigamos a \emph{existência de maus cheiros de código específicos ao \textit{front-end} de aplicativos Android relacionados a manutenibilidade}. Complementamos as pesquisas anteriores pois focamos no \textit{front-end} do Android, considerando também os recursos da aplicação em nossas análises, e também focando em qualidade de software em termos de manutenibilidade ao invés de eficiência e usabilidade. Fizemos isso por meio da aplicação de 2 questionários online submetidos a desenvolvedores Android praticantes e 1 experimento presencial e dirigido. No total, participaram da pesquisa 3XX desenvolvedores.

Concluímos com 1) um catálogo com 13 novos maus cheiros específicos ao \textit{front-end} Android, 2) uma análise estatística da percepção de desenvolvedores praticantes sobre os maus cheiros catalogados e 3) um apêndice \textit{online} \cite{apendice} com informações para que outros pesquisadores possam replicar a pesquisa. Acreditamos que nossas contribuições podem servir a pesquisadores e desenvolvedores praticantes. Aos pesquisadores serve como ponto de partida para a definição de heurísticas de identificação dos maus cheiros e implementação de ferramentas que os identifiquem de forma automática. Aos desenvolvedores praticantes serve como auxílio na identificação de códigos problemáticos para serem melhorados, ainda que de forma manual.
...
Esta é uma importante questão a ser respondida pois nos fornece as primeiras ideias sobre maus cheiros no \textit{front-end} Android a partir da perspectiva de desenvolvedores praticantes. Fizemos isso por meio de um questionário online submetido a desenvolvedores Android perguntando-os sobre o que eles consideram boas e más práticas em oito dos elementos usados para desenvolvimento do \textit{front-end} Android e recebemos um total de 45 respostas.
