...
Conforme apresentado na Figura \ref{fig:phase1-participants-experience}, 86\% dos participantes indicaram ter 2 anos ou mais de experiência com desenvolvimento Android. Vale lembrar que a plataforma Android completa 10 anos em 2018, ou seja, 5 anos de experiência nessa plataforma representa 50\% do tempo de existência dela desde seu anúncio em 2008. 
...
\end{subfigure}% 
\caption{Experiência com desenvolvimento de software e desenvolvimento Android dos participantes de S1.}
...
\begin{figure*}[!htb]
  ...
  \caption{Conhecimento em linguagens de programação dos participantes de S1.}
...
\begin{subfigure}{.49\textwidth}
  \centering
  \includegraphics[width=.75\textwidth]{phase-1-participants-region-mundial.png}
...
\begin{subfigure}{.49\textwidth}
  ...
  \caption{Distribuição geográfica no Brasil.}
  \label{fig:phase1-participants-regions-brasil}
\end{subfigure}% 
\caption{Distribuição geográfica global e no Brasil dos participantes de S1.}
\label{fig:all-resources}
\vspace{-.5cm} 
\end{figure*}
...
\begin{figure*}[!htb]
  ...
  \caption{Conhecimento em linguagens de programação dos participantes de S2.}
  \label{fig:phase2-participants-experience}
  \vspace{-.5cm} 
\end{figure*}
...
\begin{subfigure}{.49\textwidth}
  \centering
  \includegraphics[width=.80\textwidth]{phase-2-participants-region-mundial.png}
  \caption{Distribuição geográfica global.}
  \label{fig:phase2-participants-regions-global}
\end{subfigure}
\begin{subfigure}{.49\textwidth}
  \centering
  \includegraphics[width=.90\textwidth]{phase-2-participants-region-brasil.png}
  \caption{Distribuição geográfica no Brasil.}
  \label{fig:phase2-participants-regions-brasil}
\end{subfigure}% 
\caption{Distribuição geográfica global e no Brasil dos participantes de S2.}
\label{fig:all-resources}
\vspace{-.5cm} 
\end{figure*}
