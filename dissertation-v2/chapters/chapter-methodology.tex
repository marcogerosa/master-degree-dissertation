...
Por fim, concluímos com 20 maus cheiros relacionados à camada de apresentação Android, considerados importantes e frequentes por desenvolvedores. Avaliamos a percepção no código de 7 deles, os mais importantes e frequentes, e extraímos dados estatísticos que comprovam que desenvolvedores percebem códigos afetados por seis deles como códigos problemáticos. O catálogo com os 20 maus cheiros é apresentado na Seção~\ref{phase1-code-smells-derivation}.
