...
Na terceira e última etapa, objetivamos responder a {\small \textbf{QP$_3$ Desenvolvedores Android percebem os códigos afetados pelos maus cheiros como problemáticos?}} Coletamos os dados a partir de um experimento de código online respondido por 70 desenvolvedores Android. Com esses dados foi possível extrair estatísticas sobre a percepção de desenvolvedores Android com relação a 7 dos 20 maus cheiros derivados de QP$_1$. Esses maus cheiros foram considerados os mais frequentes pelos participantes de S$_2$. Os detalhes desta etapa são apresentados na Seção~\ref{etapa-3}.

Por fim, concluímos com um catálogo com 20 maus cheiros relacionados à camada de apresentação Android, considerados importantes e frequentes por desenvolvedores Android. Avaliamos a percepção no código de 7 deles, os mais frequentes, e extraímos dados estatísticos que confirmam que desenvolvedores percebem códigos afetados por 6 deles como códigos problemáticos. O catálogo com os 20 maus cheiros é apresentado na Seção~\ref{phase1-code-smells-derivation}.
