...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=.8\textwidth]{mobile-os-growth.png}
  \caption{Participação de mercado do sistema operacional móvel global nas vendas para usuários finais do 1º trimestre de 2009 para o 1º trimestre de 2017.}
...
% \begin{itemize}
	% \sloppy
  \textbf{QP1 -} \textbf{Quais maus cheiros são vistos com mais frequência?}

	\textbf{QP2 -} \textbf{Quais maus cheiros são considerados mais importantes?}

  \textbf{QP3 -} \textbf{Códigos afetados pelos maus cheiros são percebidos como problemáticos?}
% \end{itemize}
