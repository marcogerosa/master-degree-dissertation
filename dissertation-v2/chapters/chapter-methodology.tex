...
O questionário (\emph{S1}) foi composto por 25 questões divididas em três seções. A primeira seção tinha o objetivo de traçar o perfil demográfico do participante (idade, estado de residência, experiência em desenvolvimento de software, experiência com desenvolvimento Android e escolaridade) e foi composta de 6 questões. A segunda seção foi composta por 16 questões opcionais e dissertativas sobre boas e más práticas relacionadas ao \textit{front-end} Android. Para cada elemento do \textit{front-end} Android foram feitas duas perguntas abertas, onde a participante deveria discutir sobre boas e más práticas percebidas por ele naquele elemento. Por exemplo, para o elemento \textsc{Activity} foram feitas as seguintes perguntas: 
...
\toprule
\textsc{Lógicas em view}                               & 60  &   Java     \\
\textsc{Padrão de nome de recurso}                     & 23  &   Recurso  \\ 
\textsc{Recurso mágico}                                & 23  &   Recurso  \\
\textsc{Views aninhados}                               & 18  &   Recurso  \\
\textsc{Imagem tradicional dispensável}                & 18  &   Recurso  \\
\textsc{Classes de UI acopladas}                       & 18  &   Java     \\
\textsc{Comportamento Suspeito}                        & 17  &   Java     \\
\textsc{Mau uso do ciclo de vida}                      & 14  &   Java     \\
\textsc{Layout longo ou repetido}                      & 14  &   Recurso  \\
\textsc{Não uso do padrão View Holder}                 & 13  &   Java     \\
\textsc{Ausência de diferentes resoluções de imagens}  & 12  &   Recurso  \\
\textsc{Referência Morta}                             & 10   &   Java      \\
\textsc{Uso excessivo de Fragments}                    & 9   &   Java      \\
\textsc{Classes de UI fazendo IO}                      & 9   &   Java      \\
\textsc{Não uso de Fragment}                           & 8   &   Java      \\
...
\textsc{Reuso excessivo de strings}                     & 6   &   Recurso   \\
\textsc{Não uso de arquiteturas conhecidas}             & 6   &   Java      \\
