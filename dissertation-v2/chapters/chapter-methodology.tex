...
Esta pesquisa foi dividida em três etapas conforme apresentado na Figura \ref{fig:ResearchPhases}. Cada etapa objetiva responder uma questão de pesquisa. 
...
Na terceira e última etapa, objetivamos responder a {\small \textbf{QP3. Desenvolvedores Android percebem os códigos afetados pelos maus cheiros como problemáticos?}} Coletamos os dados a partir de um experimento com 75 desenvolvedores Android. Com esses dados, foi possível extrair estatísticas sobre a percepção de desenvolvedores Android com relação aos 8 principais maus cheiros derivados de {\small \textbf{QP1}}. Os detalhes desta etapa são apresentados na Seção \ref{etapa-3}.
