...
Iniciamos nossa pesquisa com algumas hipóteses de quais práticas poderiam ser consideradas más práticas, e portanto exalando maus cheiros no desenvolvimento da camada de apresentação Android. Apesar de haver algumas hipóteses, com o objetivo de não limitar ou influenciar nesta primeira etapa, para responder a QP1, submetemos um questionário online com perguntas exploratórios sobre boas e más práticas em cada um dos componentes da camada de apresentação Android: \textsc{Activities}, \textsc{Fragments}, \textsc{Adapters}, \textsc{Listeners}, e recursos do aplicativo: \textsc{Layout}, \textsc{Strings}, \textsc{Styles} e \textsc{Drawables}. Obtivemos 45 respostas a partir do qual extraímos 46 categorias que resultaram em 21 maus cheiros, dentre os quais, estavam maus cheiros que confirmaram nossas hipóteses iniciais.
