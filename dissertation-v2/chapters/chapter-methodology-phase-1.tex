...
Este questionário (\emph{S1}) foi baseado em um estudo anterior feito por Aniche et al. \cite{AnicheSmellsMVC:17, FinavaroAniche2016}, onde os autores buscaram por maus cheiros em aplicações \acs{MVC}. Elaboramos o questionário em inglês porém havia um texto informativo avisando que tanto respostas em inglês ou português eram aceitas. O questionário foi composto por 25 questões divididas em três seções.
