...
Este questionário (\emph{S1}) foi baseado em um estudo anterior feito por Aniche et al. \cite{AnicheSmellsMVC:17, FinavaroAniche2016}, onde os autores buscaram por maus cheiros em aplicações \acs{MVC}. O questionário foi composto por 25 questões divididas em três seções. 
...
\begin{itemize}
  \item Você tem alguma boa prática para lidar com \textit{Activities}? (Pergunta aberta)
  \item Você considera alguma coisa uma má prática ao lidar com \textit{Activities}? (Pergunta aberta)
\end{itemize}
...
Participaram desta etapa da pesquisa 45 desenvolvedores Android. Dos participantes, 12\% possui uma ou mais pós-graduações e 62\% são graduados, esses dados podem ser observados na Figura \ref{fig:phase1-participants-graduation}. A Figura \ref{fig:phase1-participants-age} apresenta a distribuição de idade dos participantes, onde a maioria possui de 25 a 34 anos.  

\begin{figure*}[!h]
\centering
\begin{subfigure}{.50\textwidth}
  \centering
  \includegraphics[width=.99\textwidth]{phase1-participants-graduation.png}
  \caption{Distribuição de escolaridade.}
  \label{fig:phase1-participants-graduation}
\end{subfigure}
\begin{subfigure}{.48\textwidth}
  \centering
  \includegraphics[width=.90\textwidth]{phase1-participants-age.png}
