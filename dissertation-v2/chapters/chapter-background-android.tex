...
\centering
	\begin{subfigure}[b]{.49\textwidth}
	  \centering
	  \includegraphics[width=.9\textwidth]{activity-ciclodevida.png}
	  \caption{Principais métodos de retorno do ciclo de vida de \textit{Activities}.}
	  \label{fig:activity-lifecycle}
	\end{subfigure}
	\begin{subfigure}[b]{.49\textwidth}
	  \centering
	  \includegraphics[width=.9\textwidth]{service-ciclodevida.png}
...
São muitos os componentes e recursos disponibilizados pelo Android \ac{SDK}. Nosso estudo objetiva analisar os que estão relacionados à camada de apresentação Android. Em termos de componentes, fizemos uma extensa revisão na documentação oficial do Android \cite{AndroidDeveloperSite2016} e chegamos a quatro, são eles: \textit{Activities}, \textit{Fragments}, \textit{Adapters} e \textit{Listeners}. 

Em termos de recursos, todos são por natureza relacionados à camada de apresentação. O Android provê mais de quinze diferentes tipos de recursos \cite{AndroidResourceType}. Com o objetivo de focar a pesquisa, optamos por selecionar os principais recursos. Para isso, nos baseamos no projeto padrão criado pelo Android Studio \cite{FirstApp2017}, são eles: recursos de \textit{Layout}, recursos de \textit{Strings}, recursos de \textit{Style} e recursos \textit{Drawable}. De modo genérico chamaremos os componentes e recursos mencionados aqui de ``elementos'' da camada de apresentação Android.
...
\centering
  \begin{subfigure}[b]{.33\textwidth}
    \centering
    \includegraphics[width=0.9\textwidth]{activity-ciclodevida.png}
    \caption{\textit{Activity}.}
    \label{fig:activity-lifecycle}
  \end{subfigure}
  \begin{subfigure}[b]{.33\textwidth}
    \centering
    \includegraphics[width=0.9\textwidth]{fragment-ciclodevida.png}
