...
\noindent \textbf{\textit{Recursos de Style}} são XMLs utilizados para a definição de estilos a serem aplicados nos XMLs de \textit{layout}. As principais vantagens em se utilizar recursos \textit{Styles} é separar o código de estrutura da \acs{UI} do código que define sua aparência e forma, e também possibilitar a reutilização de estilos em diferentes \acs{UI}s~\cite{AndroidStyleResources}.
