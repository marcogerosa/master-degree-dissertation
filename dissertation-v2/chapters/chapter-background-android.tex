...
Nesta dissertação, quando estivermos nos referindo a ambos, \textbf{\small componentes} (código Java) e \textbf{\small recursos} (arquivos XML e imagens), chamaremos de \textbf{\small elementos da camada de apresentação Android}. A seguir introduzimos brevemente cada um dos 8 elementos da camada de apresentação Android, investigados nesta pesquisa:
...
Nesta seção, para exemplificarmos o problema de pesquisa, tratamos de dois desafios no desenvolvimento da camada de apresentação Android. O primeiro trata do desenvolvimento de uma tela e o segundo trata da alta complexidade do ciclo de vida de componentes da camada de apresentação em comparação a outros componentes.
