...
Android é o sistema operacional móvel, de código aberto, mais usado em 2017 que apresenta crescimento acentuado há quase uma década. No início de 2017 apresenta participação de mercado de mais de 86\% das vendas globais de \textit{smartphones} para usuários finais. A segunda plataforma móvel mais usada em \textit{smartphones} é o iOS, entretanto, sua participação no mercado é bem tímida se comparado ao Android nos dias atuais \cite{GlobalSmartphoneSales:09-17}. Podemos observar estes dados na Figura \ref{fig:MobileMarketShare09-17}.
