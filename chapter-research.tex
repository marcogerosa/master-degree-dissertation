...
\section{Q1: Abordagem de Definição dos Maus Cheiros}
...
\section{Catálogo de Maus Cheiros da Camada de Apresentação Android} 
...
\section{Impacto na Tendência a Defeitos}
\label{sc:BugProneness}
