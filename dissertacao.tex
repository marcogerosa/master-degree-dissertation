...
\usepackage{titletoc}
\usepackage{booktabs}                   % para geração de tabelas
...
% ---------------------------------------------------------------------------- %
% Dimensões da página (letterpaper)
...
%pdfkeywords={Mobile, Computação Movel, Celular} % <== Precisa rever o que vai colocar aqui !!!
...
\include{cap-fundamentacao-teorica} 
\include{cap-pesquisa} 
\include{cap-catalogo-smells} 
