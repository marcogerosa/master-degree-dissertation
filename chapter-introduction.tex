...
Nesta dissertação objetivamos mapear \textbf{maus cheiros específicos à camada de apresentação de projetos Android}. Para isso, exploramos as seguintes questões:
...
O objetivo desta questão é obter insumos para a definição dos maus cheiros e propostas de como refatorá-los. Para responder esta questão elaboramos um questionário para coletar boas e más práticas utilizadas ou percebidas por desenvolvedores Android com relação à camada de apresentação a ser aplicado na comunidade de desenvolvedores Android do Brasil e exterior.

Pretende-se também coletar postagens em fóruns e blogs técnicos que abordem boas e más práticas com relação a camada de apresentação em aplicativos Android. Com isso acredita-se obter uma base sólida para a análise e extração dos maus cheiros. A lista de maus cheiros resultante será validada com desenvolvedores Android especialistas. Os itens mencionados são detalhadas na seção \ref{sc:CodeSmellsDefinition} do capítulo \ref{ch:research}.

TODO: Entrevistas com devs android.
