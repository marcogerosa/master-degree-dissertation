...
Nesta dissertação pretendemos mapear \textbf{alguns maus cheiros específicos à camada de apresentação de projetos Android}. Para isso, exploramos as seguintes questões:
...
\textbf{Q2: O que desenvolvedores consideram boas e más práticas com relação a \emph{Camada de Apresentação} de um projeto Android?}
...
\begin{itemize}
	...
	\item \textbf{Capítulo 5} Catálogo de \textit{Code Smells}
